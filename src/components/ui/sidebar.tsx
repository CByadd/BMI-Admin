    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="w-[--sidebar-width] bg-sidebar bg-card p-0 text-sidebar-foreground [&>button]:hidden shadow-xl"
          style={
            {
          ...
          side={side}
        >
          <div className="flex h-full w-full flex-col shadow-inner">{children}</div>
        </SheetContent>
      </Sheet>
    );
  }
